...
const { login, checkUser, checkCustomUser, createCookies, signUp, customLogin, activate } = require("./src/auth")
const { feedback } = require("./src/inq")
const { joinProject, userList, userEvents, userProfile, projectSubmit, projectGet, addEvent, getUserByUID, getProjectByUID, getEventByUID } = require("./src/user")
const { AllProject, AllEvent, getProjectByID, getEventByID, TopProject, faq, SubmitFaq } = require("./src/extra")
...
app.get("/", (req, res) => res.json({ message: "This is a server # Don't mesh it up" }))
//////////////////////////////////////////////////////
...
server.listen(PORT, function () {
  ...
  console.log("server is running on :" + PORT + " in " + env)
})
